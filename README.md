...
Cài Node.js 22 trở lên và npm. Giải nén toàn bộ gói, ví dụ vào `C:\NganHangCauHoi`.
...
Hoặc chạy Terminal tại thư mục chứa package.json trên Windows/macOS/Linux:
...
Chỉnh **server/.env** (có `.env.example` ở cả thư mục gốc và server):
